...
export default function HealthCareServiceDetails() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 place-items-center">
            ...
            <div className="group rounded-xl border border-gray-200 p-6 bg-white shadow-sm flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-accent/50 hover:scale-[1.02] hover:bg-accent [&_*]:transition-colors [&_*]:duration-300 hover:text-black">
              <div className="text-4xl mb-3">📄</div>
              <h3 className="text-lg font-semibold text-navy mb-2">CoS & Documents</h3>
              <p className="text-muted-foreground">Review of your Certificate of Sponsorship and supporting documents.</p>
            </div>
            <div className="group rounded-xl border border-gray-200 p-6 bg-white shadow-sm flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-accent/50 hover:scale-[1.02] hover:bg-accent [&_*]:transition-colors [&_*]:duration-300 hover:text-black">
              <div className="text-4xl mb-3">📝</div>
              <h3 className="text-lg font-semibold text-navy mb-2">Application Prep</h3>
              <p className="text-muted-foreground">Preparation and submission of your Health and Care visa application.</p>
            </div>
            <div className="group rounded-xl border border-gray-200 p-6 bg-white shadow-sm flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-accent/50 hover:scale-[1.02] hover:bg-accent [&_*]:transition-colors [&_*]:duration-300 hover:text-black">
              <div className="text-4xl mb-3">📬</div>
              <h3 className="text-lg font-semibold text-navy mb-2">Updates</h3>
              <p className="text-muted-foreground">Guidance and updates until your visa decision is made.</p>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto mt-6 rounded-xl border border-gray-200 bg-accent/10 ring-1 ring-accent/30 p-6 text-left">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2"><span className="text-green-600">✔</span><span className="text-[18px] text-black">Preparation and submission of your Health and Care visa application</span></li>
              <li className="flex items-start gap-2"><span className="text-green-600">✔</span><span className="text-[18px] text-black">Updates and guidance until your visa decision is made</span></li>
            </ul>
          </div>
